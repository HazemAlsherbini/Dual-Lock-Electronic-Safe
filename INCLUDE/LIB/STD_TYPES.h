...
// Unsigned Integer Data Types (+Ve)
...
typedef unsigned long int           u32 ; // 4 bytes = 32 bits u32
typedef signed   long int             s32 ; // 4 bytes = 32 bits s32
...
typedef long double                    f128; // 16 bytes = 128 bits s128
